            ...
            <div className="Banner-center">
              <div className="Banner-info">
                <div className="Banner-image">
                  <svg className="Banner-svg" fill="none" viewBox="0 0 96 96">
                      <path
                ...
                <div className="Banner-text">
                  <p className="Banner-p Banner-p--first">Todo lo que te encanta de Netflix por solo 5,49 €.</p>
                  <p className="Banner-p Banner-p--second">Consigue el plan Estándar con anuncios.</p>
                  <a className="Banner-a" href="#"  title="Acerca de los planes">Más información</a>
                </div>
              </div>
            </div>
          </div>
