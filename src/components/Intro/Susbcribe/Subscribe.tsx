        ...
        <dialog className="Subscribe" open={isOpen}>
          <div className="Subscribe-content">
            <header className="Subscribe-header">
              <button className="Subscribe-button"  type="button" aria-label="Cerrar">
            ...
            <div className="Subscribe-body">
              ...
              <form className="Subscribe-form Form" action="#" method="post">
                ...
                <div className="Form-group Form-group--controller">
                  <button className="Form-button Form-button--back"  onClick={onClose} type="button" arial-label="Volver">Volver</button>
